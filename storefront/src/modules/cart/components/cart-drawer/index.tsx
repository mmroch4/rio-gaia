...
const CartDrawer = ({
  ...
  useEffect(() => {
    if (
      ...
      !pathname.includes("/portal/carrinho") &&
      !pathname.includes("/portal/conta")
    ) {
      timedOpen()
      return
    }
                    ...
                    {spendLimitExceeded && (
                      <div className="flex items-center gap-x-2 bg-neutral-100 p-3 rounded-md shadow-borders-base">
                        ...
                        <p className="text-neutral-950 text-xs">
                          Esta encomenda excede o seu limite de gastos. Por favor,
                          contacte o seu gestor para aprovação.
                        </p>
                      </div>
                    )}
                  </div>
