        ...
        {customer?.employee && (
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-gray-900 font-semibold mb-1">Limite de Gastos</h3>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-[#0047AB]">
                    {customer.employee.spending_limit > 0
                      ? formatAmount(
                          customer.employee.spending_limit,
                          customer.employee.company?.currency_code || "eur"
                        )
                      : "Sem limite"}
                  </span>
                  {customer.employee.is_admin && (
                    <span className="text-sm text-gray-500 uppercase">Admin</span>
                  )}
                </div>
              </div>
            </div>
